...
import { faBolt, faCalendarCheck, faCalendarDays, faCartFlatbedSuitcase, faChair, faClipboard, faGasPump, faGear, faUpDown } from '@fortawesome/free-solid-svg-icons';
                                            ...
                                            <div className='profile_fields'>
                                                <Card title={"Car Overview"}>
                                                    <List grid={{ gutter: 16, xs: 1, sm: 2, md: 4, lg: 4, xl: 6, xxl: 3 }}>
                                                        ...
                                                        />
                                                        <List.Item.Meta
                                                            avatar={<FontAwesomeIcon icon={faClipboard} />}
                                                            title={"Variant:"}
                                                            description={data.variant}
                                                        />
                                                        <List.Item.Meta
                                                            avatar={<FontAwesomeIcon icon={faCalendarDays} />}
                                                        ...
                                                        />
                                                        <List.Item.Meta
                                                            avatar={<FontAwesomeIcon icon={faGasPump} />}
                                                            title={"Fuel Type:"}
                                                        ...
                                                        />
                                                        <List.Item.Meta
                                                            avatar={<FontAwesomeIcon icon={faGear} />}
                                                            title={"Transmission:"}
                                            ...
                                            <div className='profile_fields'>
                                                <Card title={"Car Specifications"}>
                                                    <List grid={{ gutter: 16, xs: 1, sm: 2, md: 4, lg: 4, xl: 6, xxl: 3 }}>
                                                        ...
                                                        />
                                                        <List.Item.Meta
                                                            avatar={<FontAwesomeIcon icon={faUpDown} />}
                                                            title={"Ground Clearance (mm):"}
                                                            description={data.ground_clearance}
                                                        />
                                                        <List.Item.Meta
                                                            avatar={<FontAwesomeIcon icon={faCartFlatbedSuitcase} />}
                                                            title={"Boot Space (liters):"}
                                                            description={data.boot_space}
                                                        />
                                                        <List.Item.Meta
                                                            avatar={<FontAwesomeIcon icon={faChair} />}
